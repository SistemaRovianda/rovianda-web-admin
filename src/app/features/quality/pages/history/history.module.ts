...
const COMMON_DECLARATIONS = [HistoryPageComponent,DateReportsComponent, SearchDriefComponent,SearchPackagingComponent, MessagesComponent];

const COMMON_ENTRY_COMPONENTS= [SearchDriefComponent, SearchPackagingComponent, MessagesComponent, DateReportsComponent]
